            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="card card-info">
                        ...
                        $sql_edit       = mysqli_query($koneksi, "SELECT * FROM berita WHERE id_berita='$id_berita'");
                        $row_edit       = mysqli_fetch_array($sql_edit);
                        $judul           = $row_edit['judul'];
                        $isi       = $row_edit['isi'];
                        $gambar       = $row_edit['gambar'];
                        ?>

                        <form role="form" action="proses-edit-berita.php" method="POST" enctype="multipart/form-data">
                            <div class="card-body">
                                <input type="hidden" class="form-control" name="id_berita" value="<?php echo $id_berita; ?>">
                                ...
                                <div class=" form-group">
                                    ...
                                    <br>
                                    <img style="width: 30vh; height: 25vh;" src="../berita/<?php echo $gambar ?>">
                                </div>
                                <div class="form-group">

      ...
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            ...
            <b><h1 class="m-0 text-dark">Kelola Data Surat Pertanggung Jawaban</b></h1>
            ...
            <a href="tambah-biayatest.php"><button type="submit" class="btn btn-info nav-icon fas fa-edit"> Tambah Data Biaya Test</button></a>
          </div><!-- /.col -->
          <div class="col-sm-6">

...
$nama_yang_ditugaskan   = $_POST['nama_yang_ditugaskan'];
...
$query = "INSERT INTO laporan(tgl_kunjungan, tgl_selesai, tempat_tujuan, no_surat_tugas, sumber_dana, nama_yang_ditugaskan, relevansi_iku, relevansi_akreditasi, relevansi_umum, ringkasan_kunjungan, simpulan, id_user) VALUES 
('$tgl_kunjungan', '$tgl_selesai', '$tempat_tujuan', '$no_surat_tugas', '$sumber_dana', '$nama_yang_ditugaskan', '$relevansi_iku', '$relevansi_akreditasi', '$relevansi_umum', '$ringkasan_kunjungan', '$simpulan', '$id_user')";

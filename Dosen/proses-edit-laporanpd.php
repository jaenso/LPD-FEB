...
$query = "UPDATE laporan SET tgl_kunjungan='$tgl_kunjungan', tempat_tujuan='$tempat_tujuan', no_surat_tugas='$no_surat_tugas', 
sumber_dana='$sumber_dana', nama_yang_ditugaskan='$nama_yang_ditugaskan', relevansi_iku='$relevansi_iku', relevansi_akreditasi='$relevansi_akreditasi', 

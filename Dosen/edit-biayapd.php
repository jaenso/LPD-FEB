...
<div class="content-wrapper">
    ...
    <div class="content-header">
      <div class="container-fluid">
        ...
        <div class="row mb-2">
          <div class="col-sm-6">
            <b><h1 class="m-0 text-dark">Edit Data Surat Pertanggung Jawaban</b></h1>
                ...
                <input type="hidden" class="form-control" name="id_biaya" value="<?php echo $id_biaya; ?>">
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="surat_tugas" class="form-control" value="<?php echo $surat_tugas; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>

                      <div class="col-lg-6">
                        <label>Penginapan</label>
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="openginapan" class="form-control" value="<?php echo $penginapan; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="surat_pd" class="form-control" value="<?php echo $surat_pd; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>

                      <div class="col-lg-6">
                        <label>Nota Taxi</label>
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="nota_taxi" class="form-control" value="<?php echo $nota_taxi; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>
                  ...
                  <div class="form-group">
                    ...
                    <div class="col-lg-6">
                        ...
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="tik_pesawat" class="form-control" value="<?php echo $tik_pesawat; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>

                      <div class="col-lg-6">
                        <label>Uang Harian</label>
                        <input type="file" accept=".jpeg,.jpg,.png,.pdf,.docx" name="uang_harian" class="form-control" value="<?php echo $uang_harian; ?>"/>
                        <span class="text-danger"> *Masukkan File Surat Baru (Format yang diterima : .jpeg, .jpg, .png, .pdf, .docx)</span>
                      </div>
